/**
 * Jalali (Solar Hijri) calendar conversion — port of the well-tested
 * jalaali-js algorithm (Borkowski). Pure arithmetic, no dependencies,
 * correct month lengths and leap years for 1178–1633 Jalali.
 */
...
/** Saturday-first Persian weekday names (index = getDay() offset handled by caller). */
export const WEEKDAYS_FA_LONG = [
  "شنبه",
  "یک‌شنبه",
  "دوشنبه",
  "سه‌شنبه",
...
export const WEEKDAYS_EN_SHORT = ["Sa", "Su", "Mo", "Tu", "We", "Th", "Fr"];
